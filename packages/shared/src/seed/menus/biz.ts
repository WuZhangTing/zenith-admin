...
export const SEED_MENUS_BIZ: Menu[] = [
  ...
  { id: 11031, parentId: 11030, title: '提交演示任务', type: 'button', permission: 'biz:task-demo:submit', sort: 1, status: 'enabled', visible: true, createdAt: SEED_DATE, updatedAt: SEED_DATE },
