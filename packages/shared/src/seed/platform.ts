...
export const SEED_SYSTEM_CONFIGS: SystemConfig[] = [
  ...
  { id: 18, configKey: 'ai_allow_user_custom_key', configName: '用户自定义 AI Key',      configValue: 'false', configType: 'boolean', description: '是否允许用户配置自己的 AI API Key（关闭时所有用户均使用系统默认服务商）', createdAt: SEED_DATE, updatedAt: SEED_DATE },
  ...
  { id: 25, configKey: 'upload_session_ttl_hours', configName: '分片上传会话保留时长',      configValue: '24',    configType: 'number',  description: '分片上传会话保留时长（小时）；超过该时长仍未完成的会话及其临时分片将被定时清理', createdAt: SEED_DATE, updatedAt: SEED_DATE },
