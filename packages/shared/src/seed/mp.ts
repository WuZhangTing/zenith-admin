import type { MpAccount, MpAutoReply, MpBroadcast, MpDraft, MpFan, MpKfAccount, MpKfRoutingStrategy, MpKfSessionCloseReason, MpKfSessionEventType, MpKfSessionStatus, MpMaterial, MpMenu, MpMenuButton, MpMenuMatchRule, MpMenuStatus, MpMessage, MpMessageTemplate, MpQrcode, MpTag } from '../mp/types';
