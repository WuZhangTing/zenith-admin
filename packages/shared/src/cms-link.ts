...
export type CmsLinkRef =
  /** 站内实体引用 */
  | { kind: 'entity'; entityType: CmsLinkEntityType; id: number }
...
export function parseCmsLink(raw: string | null | undefined): CmsLinkRef | null {
  ...
  if (entity) {
    ...
    return { kind: 'entity', entityType: entity[1] as CmsLinkEntityType, id };
  }
