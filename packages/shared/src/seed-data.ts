...
export const SEED_CMS_CHANNELS: CmsChannel[] = [
  ...
  { id: 4, siteId: 2, parentId: 0, modelId: 1, name: '技术动态', code: 'news', slug: 'news', path: 'news', type: 'list', linkUrl: null, listTemplate: null, detailTemplate: null, pageSize: 20, pageContent: null, seoTitle: null, seoKeywords: null, seoDescription: '来自根站点治理分发的技术动态', image: null, visible: true, status: 'enabled', sort: 1, settings: {}, createdAt: SEED_DATE, updatedAt: SEED_DATE },
];
