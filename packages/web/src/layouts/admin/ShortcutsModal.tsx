    ...
    >
      {([
        ...
        <div key={group}>
          ...
          <div className="auto-grid" style={{ ['--auto-grid-min' as string]: '240px', ['--auto-grid-cols' as string]: 2, ['--auto-grid-row-gap' as string]: '2px', marginBottom: index < arr.length - 1 ? 12 : 0 }}>
            {items.map(({ keys, desc }) => (
