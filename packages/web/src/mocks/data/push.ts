...
export const mockPushConfigs: PushConfig[] = [
  {
    ...
    apnsProduction: true, isDefault: true, status: 'enabled', remark: '生产环境聚合推送',
...
export const mockPushSendLogs: PushSendLog[] = [
  {
    id: 1, configId: 1, provider: 'jpush', subjectType: 'user', subjectId: 1, subjectName: '管理员',
  ...
  {
    id: 2, configId: 1, provider: 'jpush', subjectType: null, subjectId: null, subjectName: null,
