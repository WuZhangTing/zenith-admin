...
export const mockPaymentOrders: PaymentOrder[] = [
  { id: 1, orderNo: 'PAY1700000000001', outTradeNo: 'PAY1700000000001', channelTradeNo: '4200001234567890', bizType: 'membership', bizId: '1001', subject: '会员充值-年度套餐', body: null, amount: 9900, currency: 'CNY', channel: 'wechat', channelConfigId: 1, appId: 1, payMethod: 'wechat_native', status: 'success', userId: 1, openId: null, clientIp: '127.0.0.1', departmentId: null, paidAmount: 9900, feeAmount: 59, netAmount: 9841, paidAt: SEED, expiredAt: SEED, errorMessage: null, version: 0, createdAt: SEED, updatedAt: SEED },
  { id: 2, orderNo: 'PAY1700000000002', outTradeNo: 'PAY1700000000002', channelTradeNo: null, bizType: 'order', bizId: '2002', subject: '商品订单-手机壳', body: null, amount: 4990, currency: 'CNY', channel: 'alipay', channelConfigId: 2, appId: 3, payMethod: 'alipay_page', status: 'paying', userId: 1, openId: null, clientIp: '127.0.0.1', departmentId: null, paidAmount: null, feeAmount: null, netAmount: null, paidAt: null, expiredAt: SEED, errorMessage: null, version: 0, createdAt: SEED, updatedAt: SEED },
  { id: 3, orderNo: 'PAY1700000000003', outTradeNo: 'PAY1700000000003', channelTradeNo: '4200009876543210', bizType: 'membership', bizId: '1002', subject: '会员充值-月度套餐', body: null, amount: 1900, currency: 'CNY', channel: 'wechat', channelConfigId: 1, appId: 1, payMethod: 'wechat_jsapi', status: 'refunded', userId: 1, openId: 'oABC123XYZ', clientIp: '127.0.0.1', departmentId: null, paidAmount: 1900, feeAmount: 11, netAmount: 1889, paidAt: SEED, expiredAt: SEED, errorMessage: null, version: 0, createdAt: SEED, updatedAt: SEED },
  { id: 4, orderNo: 'PAY1700000000004', outTradeNo: 'PAY1700000000004', channelTradeNo: '2024010122001234567', bizType: 'order', bizId: '2008', subject: '商品订单-蓝牙耳机', body: null, amount: 8800, currency: 'CNY', channel: 'alipay', channelConfigId: 2, appId: 3, payMethod: 'alipay_wap', status: 'refunding', userId: 1, openId: null, clientIp: '127.0.0.1', departmentId: null, paidAmount: 8800, feeAmount: 52, netAmount: 8748, paidAt: SEED, expiredAt: SEED, errorMessage: null, version: 0, createdAt: SEED, updatedAt: SEED },
];
let nextOrderId = 5;
export const getNextPaymentOrderId = () => nextOrderId++;

export const mockPaymentRefunds: PaymentRefund[] = [
  { id: 1, refundNo: 'REF1700000000003', outRefundNo: 'REF1700000000003', orderNo: 'PAY1700000000003', orderId: 3, channelRefundNo: '50000012345', channel: 'wechat', refundAmount: 1900, totalAmount: 1900, reason: '用户申请退款', status: 'success', approvalStatus: 'none', operatorId: 1, refundedAt: SEED, errorMessage: null, version: 0, createdAt: SEED, updatedAt: SEED },
  { id: 2, refundNo: 'REF1700000000004', outRefundNo: 'REF1700000000004', orderNo: 'PAY1700000000004', orderId: 4, channelRefundNo: null, channel: 'alipay', refundAmount: 3000, totalAmount: 8800, reason: '部分退款-差价补偿', status: 'processing', approvalStatus: 'none', operatorId: 1, refundedAt: null, errorMessage: null, version: 0, createdAt: SEED, updatedAt: SEED },
