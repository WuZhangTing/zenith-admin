    ...
    >
      ...
      {enablePageBreak && !readOnly ? (
        <div style={{ padding: '4px 8px', borderBottom: '1px solid var(--semi-color-border)', backgroundColor: 'var(--semi-color-fill-0)', display: 'flex', alignItems: 'center', gap: 8 }}>
          <button
            type="button"
            style={{ border: '1px solid var(--semi-color-border)', borderRadius: 'var(--semi-border-radius-small)', padding: '2px 10px', background: 'var(--semi-color-bg-1)', cursor: 'pointer', fontSize: 12, color: 'var(--semi-color-text-1)' }}
